        ...
        <section class="Hero">
            ...
            <div class="contact-numbers">
                <div class="contact-item">
                    <img src="{{ asset('images/Phone.svg') }}" alt="Logo 1">
                    <a href=""><span>+91-99954XXXXX</span></a>
                </div>
                <div class="contact-item">
                    <img src="{{ asset('images/WhatsApp.svg') }}" alt="Logo 2">
                    <a href=""><span>+91-99954XXXXX</span></a>
                </div>
            </div>
            <div class="content">
                ...
                <button id="btn">Contact us <img src="{{ asset('images/Vector.png') }}" alt=""></button>
            </div>
            ...
            <div class="cards-container">
                ...
                <div class="card">
                    <div class="card-inner">
                        ...
                        <div class="card-back">
                            <img src="{{ asset('images/back1.png') }}" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-inner">
                        ...
                        <div class="card-back">
                            <img src="{{ asset('images/back2.png') }}" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-inner">
                        ...
                        <div class="card-back">
                            <img src="{{ asset('images/back3.png') }}" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-inner">
                        <div class="card-front">
                            <img src="{{ asset('images/Card 4.png') }}" alt="Card 4">
                        </div>
                        <div class="card-back">
                            <img src="{{ asset('images/back4.png') }}" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-inner">
                        <div class="card-front">
                            <img src="{{ asset('images/Card 5.png') }}" alt="Card 5">
                        </div>
                        <div class="card-back">
                            <img src="{{ asset('images/back5.png') }}" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-inner">
                        <div class="card-front">
                            <img src="{{ asset('images/Card 6.png') }}" alt="Card 6">
                        </div>
                        <div class="card-back">
                            <img src="{{ asset('images/back6.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <footer class="footer">
                <div class="footer-content">
                    ...
                    <div class="social-icons">
                        ...
                        <img src="{{ asset('images/linkedin-in.png') }}" alt="">
